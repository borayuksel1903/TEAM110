...
import pyrebase
#from flask_api import FlaskAPI, status, exceptions, Blueprint

# Set up the client_api to use
...
# Defining the route for result
@client_api.route('/result', methods = ['GET', 'POST'])
def result():
