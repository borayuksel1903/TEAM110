...
# imports for other backend files
from client import client_api
from getMPG import getMPG_api
from getPrices import getPrice_api
...
# Registering the backend api with blueprint
app.register_blueprint(client_api)
app.register_blueprint(getMPG_api)
app.register_blueprint(getPrice_api)
